...
const Project = () => {
  ...
  // Handle user click for selecting collaborators
  ...
  // Initialize socket and fetch project data
  useEffect(() => {
  ...
  function saveFileTree(ft) {
    axios
      ...
      .then((res) => {
        console.log(res.data);
        toast.success("File tree updated successfully");
      })
      .catch((err) => {
        console.error(err);
        toast.error("Failed to update file tree");
      });
  }
  ...
  return (
    <>
      ...
      <main className="h-screen w-screen flex">
        ...
        {/* Right section for file explorer and code editor */}
